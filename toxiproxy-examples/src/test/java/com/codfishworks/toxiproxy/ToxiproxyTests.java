...
public class ToxiproxyTests {
    ...
    private static GenericContainer redis = new GenericContainer("redis:7.0.5-alpine")
    ...
    public void canConnectToRedisDirectly() {
        RedisClient client = RedisClient.create("redis://" + redis.getHost() + ":" + redis.getFirstMappedPort());
