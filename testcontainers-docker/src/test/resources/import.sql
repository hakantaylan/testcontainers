...
--INSERT INTO EMPLOYEE(id,first_name,last_name,gender,birth_date,hire_date,department_id,vehicle) VALUES(nextval('hibernate_sequence'),'Alex','Bonilla','M','1990-12-07','2011-04-01',100,'CAR');
...
--INSERT INTO EMPLOYEE(id,first_name,last_name,gender,birth_date,hire_date,department_id) VALUES(nextval('hibernate_sequence'),'Marvin','Hope','F','1978-02-21','2003-09-10',102);
--INSERT INTO EMPLOYEE(id,first_name,last_name,gender,birth_date,hire_date,department_id) VALUES(nextval('hibernate_sequence'),'Ibrar','Garcia','F','1994-12-01','2004-12-21',102);
