...
public class ProxyAwareFailureScenarioTest {
    private Network network = Network.newNetwork();

    KafkaContainer kafka = new ProxyAwareKafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:7.4.0"))
            .withKraft()
    ...
    static ToxiproxyContainer.ContainerProxy kafkaProxy;
